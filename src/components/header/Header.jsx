      ...
      <Container>
        <div className="flex items-center justify-between">
          ...
          <form
            ...
            className="border max-w-[600px] flex-1 flex border-gray-300 p-4 rounded-[30px]"
          >
            <input
              value={searchValue}
          ...
          <div className="border border-gray-300 rounded-[30px] flex relative items-center">
            <input
              ...
              id="theme-toggle"
              type="checkbox"
              className="appearance-none w-[70px] h-[30px]"
            />
            <label
              htmlFor="theme-toggle"
              className="w-[35px] h-[35px] bg-indigo-700 text-white rounded-full flex items-center justify-center cursor-pointer absolute left-0 transition-all"
            >
